...
import funkin.backend.utils.StageData;
import funkin.backend.utils.WeekData;
import funkin.backend.system.Song;
import funkin.backend.system.Section;
import funkin.backend.assets.Rating;
...
import funkin.menus.GameOverSubstate;
...
#if LUA_ALLOWED
import psychlua.*;
import funkin.backend.scripts.lua.*;
import funkin.backend.scripts.hscript.*;
import funkin.backend.scripts.sprites.*;
import funkin.backend.scripts.*;
#else
import funkin.backend.scripts.lua.LuaUtils;
import funkin.backend.scripts.hscript.HScript;
#end
...
class PlayState extends MusicBeatState
{
	...
	private var luaDebugGroup:FlxTypedGroup<funkin.backend.scripts.lua.DebugLuaText>;
	#end
