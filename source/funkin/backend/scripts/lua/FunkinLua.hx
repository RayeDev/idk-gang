#if LUA_ALLOWED
package funkin.backend.scripts.lua;
...
import funkin.backend.scripts.lua.LuaUtils.LuaTweenOptions;
import funkin.backend.scripts.lua.DebugLuaText;
import funkin.backend.scripts.sprites.ModchartSprite;
#if SScript
